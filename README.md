...
**タグ [`v1.0-lab-rc1`](https://github.com/Aero123421/Ninlil-Runtime/releases/tag/v1.0-lab-rc1)** で公開済みの **V1 LAB RC1** は、隔離 LAB 向け host simulation の **機能完成** リリースです。縦切り 10 項目（コード・テスト・文書・統合 E2E）が揃い、stub / TODO / 未接続は 0 です。統合 E2E gate（単一 topology 全経路 + 9 故障注入）で false success 0・bounded termination・範囲外 fail-closed を実証しています。
...
```bash
git clone https://github.com/Aero123421/Ninlil-Runtime.git ninlil-d3s3-implementation
