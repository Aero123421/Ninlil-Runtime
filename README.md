...
- Domain Store remaining D2 slices（S4 exact-get seam / S5 DSR1+DSR2 composition）、D3相互validation（EVIDENCE live L/cardinality/primary PVD/target match を含む）、D4 operation別commit-unknown convergence
