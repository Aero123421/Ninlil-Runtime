...
- **R7 T1b context binding / verified HKDF schedule（docs-only Proposed）:** Hop/E2E canonical bytes、binding digest、expected-digest必須のtyped key bundleを[docs/33](docs/33-r7-t1b-context-binding-hkdf.md) / [ADR-0013](docs/adr/0013-r7-t1b-context-binding-hkdf.md)で提案。**production実装・vectors・CI・独立受入は未実施。T1b/R7 full、state/W1/HIL/legal/production radioは未完。**
