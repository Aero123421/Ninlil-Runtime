...
### R2: Physical Compliance Permit authority freeze（docs only; implementation pending）
...
実装は [23章 §10.2](23-usb-radio-boundary.md) の **R1–R10** に分割する。R2 は [24章](24-r2-physical-compliance-permit-authority.md) に従う。R6 以前に production radio wire bytes を固定しない。
