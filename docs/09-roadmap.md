...
- **R7 T1b context binding / verified HKDF schedule docs-only Proposed**（[33章](33-r7-t1b-context-binding-hkdf.md) / [ADR-0013](adr/0013-r7-t1b-context-binding-hkdf.md) Proposed）。Hop/E2E canonical bindingとtyped key bundleの仕様だけを固定し、production実装・subset vectors・CI・独立受入は未実施。**T1b/R7 full、state/W1/HIL/legal/production radioを完成扱いにしない。**
