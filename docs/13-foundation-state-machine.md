...
| ADMISSION_COMMITTING | commit前のdefinite failure | REJECTED | NINLIL_E_STORAGE | NINLIL_REASON_STORAGE_IO |
| ADMISSION_COMMITTING | commit結果不明 | COMMIT_UNKNOWN | NINLIL_E_STORAGE_COMMIT_UNKNOWN | NINLIL_REASON_STORAGE_COMMIT_UNKNOWN |
