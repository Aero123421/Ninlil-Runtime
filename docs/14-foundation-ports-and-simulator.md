...
| ESP-IDF storage/clock/entropy/execution port | M3 | 本章のportable conformance subsetとpower-cut HILが必須。**M3-prep**（component packaging + pinned esp32s3 compile smoke; [18章](18-m3-prep-esp-idf-component.md)）は本 row を満たさない |
