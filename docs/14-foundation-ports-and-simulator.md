...
| ESP-IDF storage/clock/entropy/execution port | M3 | 本章のportable conformance subsetとpower-cut HILが必須。**M3-prep**（component packaging; [18章](18-m3-prep-esp-idf-component.md)）は本 row を満たさない。**M3-basic**（clock/entropy/execution adapters; [20章](20-m3-basic-esp-idf-platform-adapters.md)）は basic adapter のみで、storage/HIL/owner-task body/conformance subset を代替しない |
