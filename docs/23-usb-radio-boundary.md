...
状態: **Normative for U0 / physical radio boundary freeze** + **U1 implementation candidate / host tests**（**U1 complete ではない** — **Required HIL Linux+macOS pending**; **USB series 未完成**; **ESP CDC / A2 未実装**; **SX1262 production code 未実装**; M3 incomplete / M5 incomplete）<br>
...
| USB / SX1262 production 実装 | U0 時点は **しない**（docs freeze） | **U1 implementation candidate / host tests** あり（complete ではない; Required HIL pending）。**A2/ESP CDC・SX1262 未実装** |
