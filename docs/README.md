...
| 24 | [R2 Physical Compliance Permit authority](24-r2-physical-compliance-permit-authority.md) | P1 durable authority Normative freeze（§14 + semantic `pcp_r2_docs_gate`; FIFO/advance/fresh-epoch/ops→user/publish/airtime; **implementation pending; re-review GO 禁止**） |
