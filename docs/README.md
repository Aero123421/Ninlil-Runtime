...
| 23 | [USB control transport and physical radio boundary](23-usb-radio-boundary.md) | U0: compile≠runtime 依存、session ownership、Controller-only HELLO、Permit TX order+SiteAssignment、Required HIL、U1–U7 / R1–R10（docs freeze; USB/SX1262 code 非対象; Attachment/Join 後続） |
