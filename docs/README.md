...
| 23 | [USB control transport and physical radio boundary](23-usb-radio-boundary.md) | U0 freeze + **U1 implementation candidate / host tests**（Required HIL Linux+macOS pending; U1 complete ではない; USB series 未完成; SX1262 未実装; Attachment/Join 後続） |
