...
**R7 T0 private crypto provider candidate は local acceptance P0=P1=P2=0 GO、remote CI確認待ち**（[31章](31-r7-crypto-provider-and-aead.md) / [ADR-0011](adr/0011-r7-crypto-provider-boundary.md) Proposed）。R7 full wire/state、実機KAT、RF/USB HIL、legal、production radioは未完であり、T0のcompile/link evidenceから完成を主張しない。
