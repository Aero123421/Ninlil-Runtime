...
**D3-S0 + D3-S1a + D3-S2a + D3-S3a + D3-S4a docs freeze complete / D3-S1 implementation complete / D3-S2/S3/S4 implementation + D3-S5..S12 pending**（Stage 5 / public Runtime still pending）。**durable storage PR #80 merged（HIL pending）**。**U0 boundary docs freeze complete / U1 host candidate / U2 ESP CDC candidate / U3 host framing-session candidate / U4 logical session host candidate / R1 radio_hal host candidate / R2 authority host candidate / U5·U6 docs freeze（実装 pending） / R3 airtime host candidate / R4 SX1262 control-plane host candidate / U7・R5–R10 pending**。対象release: Foundation / pre-alpha
