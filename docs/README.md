...
状態: M0 public baseline complete。M1a Domain StoreはD1-A〜D1-B3o、D2-S1〜S6を実装済み。**D2 bounded scanner / DSR1_SCAN / DSR2_ESP_BOUND complete**、**D2-S6 private fail-closed seam implemented**。Stage 5、D3 finding correctness、D4、public Runtime、ESP-IDF、hardwareは未完了。D3–D4 otherwise pre-alpha。<br>
**D2-S6 private fail-closed seam implemented**（Stage 5 / public Runtime still pending）。対象release: Foundation / pre-alpha
