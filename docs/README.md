...
**D3-S0 + D3-S1a + D3-S2a + D3-S3a + D3-S4a docs freeze complete / D3-S1 implementation complete / D3-S2/S3/S4 implementation + D3-S5..S12 pending**（Stage 5 / public Runtime still pending）。**durable storage PR #80 merged（HIL pending）**。**U0 boundary docs freeze complete / U1 host candidate / U2 ESP CDC candidate / U3 host framing-session candidate / U4 logical session host candidate / R1 radio_hal host candidate / R2 authority host candidate / U5·U6 docs freeze（実装 pending） / R3 airtime host candidate / R4 SX1262 control-plane host candidate / R5 LAB_ONLY profile host candidate / R6 NRW1 secure radio wire docs freeze Accepted（Stage 9; independent re-GO 2026-07-19 P0=P1=P2=0; R7 full AEAD / M4·M5 / ESP N6 capacity / RF·USB 実機 HIL / legal / production 未完） / U7・R7–R10 pending**。対象release: Foundation / pre-alpha
