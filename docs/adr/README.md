...
- [ADR-0011: R7 Private Crypto Provider Boundary](0011-r7-crypto-provider-boundary.md)（**Proposed**; [31章](../31-r7-crypto-provider-and-aead.md); R6 N6 hash pin不変、portable validation wrapper + Host OpenSSL exact 3.x + ESP-IDF v5.5.3 mbedTLS; local implementation/independent acceptance GO、remote CI確認待ち。R7 full / 実機KAT / RF・USB HIL / legal 未完）
