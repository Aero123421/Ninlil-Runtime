...
- [ADR-0012: R7 T1 NRW1 SINGLE Pure Wire Codec](0012-r7-t1-nrw1-single-wire-codec.md)（**Proposed**; [32章](../32-r7-t1-nrw1-single-wire-codec.md); DATA/SINGLE dual-envelope private pure codec、caller-supplied key/IV/counter、各layer atomic Open、state-bypass composite禁止、subset vectors分離。**code/acceptance、R7 full、state/W1/HIL/legalは未完**）
