...
- [ADR-0013: R7 T1b Context Binding and Verified HKDF Schedule](0013-r7-t1b-context-binding-hkdf.md)（**Proposed / docs-only**; [33章](../33-r7-t1b-context-binding-hkdf.md); implementation/acceptance、R7 full、state/W1/HIL/legalは未完）
