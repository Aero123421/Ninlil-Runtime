...
6. **B5-LAB application capability 群**: 複数 ServiceDescriptor 登録/分配、LatestState、MeasurementBatch、BoundedTransfer(partial-apply=0)、ConfigRevision、target resolver の基本経路（M2 深部=counter-offer race 全解決等は V2 へ、生成/保存まで V1）。
