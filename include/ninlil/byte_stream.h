...
/*
 * C1: Portable byte-stream contract (formal public adapter surface).
 *
 ...
 *
 * Public path: include/ninlil/byte_stream.h (installed / ESP component
 * INCLUDE_DIRS). Self-contained under -I include alone.
 * Private twin: src/transport/byte_stream.h (internal TUs include
 * "byte_stream.h"; also self-contained — not a shim). Private transport
 * roots must not be exported as public INCLUDE_DIRS.
 *
 ...
 * - Not RELEASE_SUPPORTED; experimental adapter surface.
 */
