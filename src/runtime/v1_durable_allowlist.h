...
typedef enum ninlil_v1_durable_operation {
    ...
    NINLIL_V1_DURABLE_OP_C3_REPLAY_ADMISSION_COMMIT = 16,
    NINLIL_V1_DURABLE_OP_BEARER_STATE_COMMIT = 17,
    NINLIL_V1_DURABLE_OP_APPLICATION_ATTEMPT_PREPARE_COMMIT = 18,
    NINLIL_V1_DURABLE_OP_DESTROY_RECOVERY_COMMIT = 19
