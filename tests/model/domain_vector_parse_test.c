 ...
 * Bit 34 is now real D1-B3e (subtype 34); synthetic missing/truncation
...
static const char *top_ok_prefix =
    "{\"version\":1,\"format\":\"ninlil-domain-store-v1-d1b3e\","
...
int main(void)
{
     ...
     * not truncate. Bit 34 is real/required (subtype 34); synthetic
