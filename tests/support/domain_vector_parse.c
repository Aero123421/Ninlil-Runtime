...
#define CAT(name, field, bit)                                                  \
    if (strcmp(key, name) == 0) {                                              \
        ...
        CAT("dsb3_subtype_31_positive", dsb3_subtype_31_positive,
            NINLIL_DV_CAT_DSB3_31)
        CAT("dsb3_subtype_34_positive", dsb3_subtype_34_positive,
            NINLIL_DV_CAT_DSB3_34)
        CAT("dsb3_subtype_33_positive", dsb3_subtype_33_positive,
            NINLIL_DV_CAT_DSB3_33)
        CAT("dsb3_subtype_32_positive", dsb3_subtype_32_positive,
            NINLIL_DV_CAT_DSB3_32)
        CAT("dsb3_subtype_40_positive", dsb3_subtype_40_positive,
            NINLIL_DV_CAT_DSB3_40)
        CAT("dsb3_subtype_41_positive", dsb3_subtype_41_positive,
            NINLIL_DV_CAT_DSB3_41)
        CAT("dsb3_subtype_42_positive", dsb3_subtype_42_positive,
            NINLIL_DV_CAT_DSB3_42)
        CAT("dsb3_subtype_50_positive", dsb3_subtype_50_positive,
            NINLIL_DV_CAT_DSB3_50)
        CAT("dsb3_subtype_51_positive", dsb3_subtype_51_positive,
            NINLIL_DV_CAT_DSB3_51)
        CAT("dsb3_subtype_52_positive", dsb3_subtype_52_positive,
