...
D1_COUNT = 1549
D1_SHA256 = "e7d2a7229b26fccd6f7cf821c779077fa449a03551d8ab7cda88998b6abe9502"
SELECTED = (
    ...
    # P1-C1 Mode23 equation/late templates (domain-store-v1 D1 authority).
    ("EV_TX_SUM_MAT_LEN0", "DSB3_EV_TX_SUM_MAT_LEN0_TYPED"),
    ("EV_TX_RAW_MAT", "DSB3_EV_TX_RAW_MAT_TYPED"),
    ("EV_TX_RAW_UNUSED", "DSB3_EV_TX_RAW_UNUSED_TYPED"),
)
